...
@OnlyIn(Dist.CLIENT)
public class DarkLatexWolfMaleModel extends AdvancedHumanoidModel<DarkLatexWolfMale> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("black_goo_wolf_male"), "main");
    ...
    private final HumanoidAnimator<DarkLatexWolfMale, DarkLatexWolfMaleModel> animator;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, CubeDeformation.NONE)
                .texOffs(37, 0).addBox(-1.5F, -1.0F, -6.0F, 3.0F, 1.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -0.5F, 0.0F));
        ...
        PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.2F))
                .texOffs(24, 8).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 6.0F, 8.0F, new CubeDeformation(0.3F)), PartPose.ZERO);
        ...
        PartDefinition Mask = Head.addOrReplaceChild("Mask", CubeListBuilder.create().texOffs(20, 36).addBox(-1.0F, -4.0F, -5.0F, 2.0F, 2.0F, 1.0F, CubeDeformation.NONE)
                ...
                .texOffs(15, 32).addBox(-2.0F, -2.0F, -7.0F, 4.0F, 2.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -1.0F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<DarkLatexWolfMale, DarkLatexWolfMaleModel> getAnimator(DarkLatexWolfMale entity) {
        return animator;
    }
}