...
public class ArmorLatexFemaleBirdModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexFemaleBirdModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexFemaleBirdModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_bird_female_unified"), ArmorLatexFemaleBirdModel::createArmorLayer, ArmorLatexFemaleBirdModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexFemaleBirdModel<T>> animator;

    public ArmorLatexFemaleBirdModel(ModelPart modelPart, ArmorModel model) {
        ...
        animator = HumanoidAnimator.of(this).hipOffset(-1.5f)
                .addPreset(AnimatorPresets.birdLike(Head, Torso, LeftArm, RightArm,
                        EMPTY_PART, List.of(),
                        LeftLeg, leftLowerLeg, leftFoot, leftFoot.getChild("LeftPad"), RightLeg, rightLowerLeg, rightFoot, rightFoot.getChild("RightPad"),
                        EMPTY_PART, EMPTY_PART, EMPTY_PART, EMPTY_PART));
    }
    ...
    public static LayerDefinition createArmorLayer(ArmorModel layer) {
        ...
        addUnifiedBirdLegs(partdefinition, layer);
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexFemaleBirdModel<T>> getAnimator(T entity) {
        return animator;
    }
