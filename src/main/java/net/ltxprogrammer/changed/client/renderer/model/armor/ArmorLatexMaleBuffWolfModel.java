...
public class ArmorLatexMaleBuffWolfModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexMaleBuffWolfModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexMaleBuffWolfModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_wolf_male_buff_unified"), ArmorLatexMaleBuffWolfModel::createArmorLayer, ArmorLatexMaleBuffWolfModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexMaleBuffWolfModel<T>> animator;

    public ArmorLatexMaleBuffWolfModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexMaleBuffWolfModel<T>> getAnimator(T entity) {
        return animator;
    }
