...
public class ArmorLatexHeavyCatModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexHeavyCatModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexHeavyCatModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_cat_heavy_unified"), ArmorLatexHeavyCatModel::createArmorLayer, ArmorLatexHeavyCatModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexHeavyCatModel<T>> animator;

    public ArmorLatexHeavyCatModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexHeavyCatModel<T>> getAnimator(T entity) {
        return animator;
    }
