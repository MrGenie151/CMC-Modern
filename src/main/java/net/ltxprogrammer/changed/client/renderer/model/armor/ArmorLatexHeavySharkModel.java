...
public class ArmorLatexHeavySharkModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexHeavySharkModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexHeavySharkModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_shark_heavy_unified"), ArmorLatexHeavySharkModel::createArmorLayer, ArmorLatexHeavySharkModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexHeavySharkModel<T>> animator;

    public ArmorLatexHeavySharkModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexHeavySharkModel<T>> getAnimator(T entity) {
        return animator;
    }
