...
public class ArmorMermaidSharkAbdomenModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorMermaidSharkAbdomenModel<T>> implements LeglessModel {
    ...
    public static LayerDefinition createArmorLayer(ArmorModel layer) {
        ...
        PartDefinition Tail = LowerAbdomen.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(0, 20).addBox(-4.0F, 0.25F, -2.0F, 8.0F, 4.0F, 4.0F, layer.dualDeformation.extend(0.21F)), PartPose.offset(0.0F, 5.5F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<T, ArmorMermaidSharkAbdomenModel<T>> getAnimator(T entity) {
        return animator;
    }
