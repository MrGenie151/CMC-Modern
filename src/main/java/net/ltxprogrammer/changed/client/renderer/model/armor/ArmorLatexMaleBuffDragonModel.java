...
public class ArmorLatexMaleBuffDragonModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexMaleBuffDragonModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexMaleBuffDragonModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_dragon_male_buff_unified"), ArmorLatexMaleBuffDragonModel::createArmorLayer, ArmorLatexMaleBuffDragonModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexMaleBuffDragonModel<T>> animator;

    public ArmorLatexMaleBuffDragonModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexMaleBuffDragonModel<T>> getAnimator(T entity) {
        return animator;
    }
