...
public class LatexCrystalWolfHornedModel extends AdvancedHumanoidModel<CrystalWolfHorned> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightHorn = Head.addOrReplaceChild("RightHorn", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.2F, 0.5F, 0.8F, 0.0F, -0.0873F, 0.0436F));

        PartDefinition HornBase_r1 = RightHorn.addOrReplaceChild("HornBase_r1", CubeListBuilder.create().texOffs(44, 6).addBox(-5.4F, -7.0F, 1.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F))
                .texOffs(60, 20).addBox(-5.4F, -8.0F, 2.65F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.05F))
                .texOffs(38, 22).addBox(-4.5F, -8.0F, 4.55F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.005F))
                .texOffs(40, 59).addBox(-2.5F, -8.0F, 1.65F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, -0.3491F, 0.0F));

        PartDefinition LeftHorn = Head.addOrReplaceChild("LeftHorn", CubeListBuilder.create(), PartPose.offsetAndRotation(1.2F, 0.5F, 0.8F, 0.0F, 0.0873F, -0.0436F));

        PartDefinition HornBase_r2 = LeftHorn.addOrReplaceChild("HornBase_r2", CubeListBuilder.create().texOffs(44, 4).addBox(4.4F, -7.0F, 1.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F))
                .texOffs(48, 11).addBox(4.4F, -8.0F, 2.65F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.05F))
                .texOffs(37, 0).addBox(1.5F, -8.0F, 4.55F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.005F))
                .texOffs(0, 60).addBox(0.5F, -8.0F, 1.65F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, 0.3491F, 0.0F));
