...
@OnlyIn(Dist.CLIENT)
public class DarkLatexDoubleYufengModel extends AdvancedHumanoidModel<DarkLatexDoubleYufeng> implements DoubleHeadedModel<DarkLatexDoubleYufeng> {
    ...
    private final HumanoidAnimator<DarkLatexDoubleYufeng, DarkLatexDoubleYufengModel> animator;

    public DarkLatexDoubleYufengModel(ModelPart root) {
        super(root);
        ...
        this.Mask2 = Head2.getChild("Mask2");
    ...
    public boolean isPartNotMask(ModelPart part) {
        return Mask.getAllParts().noneMatch(part::equals) && Mask2.getAllParts().noneMatch(part::equals);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition TopHorn_r1 = TopHorn.addOrReplaceChild("TopHorn_r1", CubeListBuilder.create().texOffs(48, 62).addBox(-1.0F, -1.0F, -2.2F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.15F)), PartPose.offsetAndRotation(0.0F, -4.5F, 0.5F, 0.0F, 0.0F, 0.7854F));
        ...
        PartDefinition Base_r5 = RightEar.addOrReplaceChild("Base_r5", CubeListBuilder.create().texOffs(24, 0).addBox(-0.6F, -1.5F, -3.0F, 1.0F, 3.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-0.5F, 0.0F, 0.0F, -0.2094F, -0.056F, 0.0059F));

        PartDefinition Base_r6 = RightEar.addOrReplaceChild("Base_r6", CubeListBuilder.create().texOffs(38, 62).addBox(-2.0F, -4.75F, -1.0F, 2.0F, 7.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, -0.2182F, 0.0785F));
        ...
        PartDefinition Base_r7 = LeftEar.addOrReplaceChild("Base_r7", CubeListBuilder.create().texOffs(0, 32).addBox(-0.4F, -1.5F, -3.0F, 1.0F, 3.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, -0.2094F, 0.056F, -0.0059F));

        PartDefinition Base_r8 = LeftEar.addOrReplaceChild("Base_r8", CubeListBuilder.create().texOffs(28, 61).addBox(0.0F, -4.75F, -1.0F, 2.0F, 7.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, 0.2182F, -0.0785F));
        ...
        PartDefinition Head2 = partdefinition.addOrReplaceChild("Head2", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, CubeDeformation.NONE)
                .texOffs(64, 53).addBox(-1.5F, -1.0F, -6.0F, 3.0F, 1.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -0.5F, 0.0F));

        Head2.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(56, 65).addBox(-1.9F, 0.15F, -0.3F, 2.0F, 3.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(5.5F, -5.0F, 0.0F, -1.2217F, 0.4712F, 0.6981F));

        Head2.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(0, 16).addBox(-1.4F, 0.25F, 2.3F, 2.0F, 3.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(5.5F, -5.0F, 0.0F, -1.4312F, 0.6458F, 0.5847F));

        Head2.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(64, 65).addBox(-0.1F, 0.15F, -0.3F, 2.0F, 3.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-5.5F, -5.0F, 0.0F, -1.2217F, -0.4712F, -0.6981F));

        Head2.addOrReplaceChild("Base_r4", CubeListBuilder.create().texOffs(0, 0).addBox(-0.6F, 0.25F, 2.3F, 2.0F, 3.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-5.5F, -5.0F, 0.0F, -1.4312F, -0.6458F, -0.5847F));

        PartDefinition Hair2 = Head2.addOrReplaceChild("Hair2", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.2F))
                .texOffs(24, 8).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 6.0F, 8.0F, new CubeDeformation(0.3F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        TopHorn2.addOrReplaceChild("TopHorn_r1", CubeListBuilder.create().texOffs(48, 62).addBox(-1.0F, -1.0F, -2.2F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.15F)), PartPose.offsetAndRotation(0.0F, -4.5F, 0.5F, 0.0F, 0.0F, 0.7854F));
        ...
        RightEar2.addOrReplaceChild("Base_r5", CubeListBuilder.create().texOffs(24, 0).addBox(-0.6F, -1.5F, -3.0F, 1.0F, 3.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-0.5F, 0.0F, 0.0F, -0.2094F, -0.056F, 0.0059F));

        RightEar2.addOrReplaceChild("Base_r6", CubeListBuilder.create().texOffs(38, 62).addBox(-2.0F, -4.75F, -1.0F, 2.0F, 7.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, -0.2182F, 0.0785F));
        ...
        LeftEar2.addOrReplaceChild("Base_r7", CubeListBuilder.create().texOffs(0, 32).addBox(-0.4F, -1.5F, -3.0F, 1.0F, 3.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, -0.2094F, 0.056F, -0.0059F));

        LeftEar2.addOrReplaceChild("Base_r8", CubeListBuilder.create().texOffs(28, 61).addBox(0.0F, -4.75F, -1.0F, 2.0F, 7.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, 0.2182F, -0.0785F));

        PartDefinition Mask2 = Head2.addOrReplaceChild("Mask2", CubeListBuilder.create().texOffs(0, 5).addBox(-1.0F, -31.0F, -5.0F, 2.0F, 2.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(16, 38).addBox(-2.0F, -33.0F, -5.0F, 4.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(64, 28).addBox(-3.0F, -32.0F, -5.0F, 6.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(0, 21).addBox(-1.0F, -34.0F, -5.0F, 2.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(16, 32).addBox(-4.0F, -31.0F, -5.0F, 1.0F, 2.0F, 1.0F, CubeDeformation.NONE)
        ...
        PartDefinition Base_r9 = TailPrimary.addOrReplaceChild("Base_r9", CubeListBuilder.create().texOffs(56, 57).addBox(-2.0F, -2.9F, 0.4F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5236F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r10 = TailSecondary.addOrReplaceChild("Base_r10", CubeListBuilder.create().texOffs(48, 0).addBox(-1.5F, -1.4F, -2.7F, 3.0F, 3.0F, 6.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 1.0F, 2.5F, -0.3927F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r11 = TailTertiary.addOrReplaceChild("Base_r11", CubeListBuilder.create().texOffs(46, 38).addBox(-1.5F, -13.225F, 6.6F, 3.0F, 3.0F, 6.0F, new CubeDeformation(-0.32F)), PartPose.offsetAndRotation(0.0F, 10.5F, -8.5F, -0.1309F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r12 = TailQuaternary.addOrReplaceChild("Base_r12", CubeListBuilder.create().texOffs(16, 32).addBox(-1.0F, -10.45F, 13.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.05F)), PartPose.offsetAndRotation(0.0F, 10.0F, -13.0F, 0.0436F, 0.0F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<DarkLatexDoubleYufeng, DarkLatexDoubleYufengModel> getAnimator(DarkLatexDoubleYufeng entity) {
        return animator;
    }

    private double yOffset = -2.88 / 16.0;
    private float bodyScale = 1.125F;
