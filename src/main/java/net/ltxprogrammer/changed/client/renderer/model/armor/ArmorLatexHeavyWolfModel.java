...
public class ArmorLatexHeavyWolfModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexHeavyWolfModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexHeavyWolfModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_wolf_heavy_unified"), ArmorLatexHeavyWolfModel::createArmorLayer, ArmorLatexHeavyWolfModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexHeavyWolfModel<T>> animator;

    public ArmorLatexHeavyWolfModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexHeavyWolfModel<T>> getAnimator(T entity) {
        return animator;
    }
