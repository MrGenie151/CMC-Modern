...
@OnlyIn(Dist.CLIENT)
public class DarkLatexWolfFemaleModel extends AdvancedHumanoidModel<DarkLatexWolfFemale> {
    ...
    private final HumanoidAnimator<DarkLatexWolfFemale, DarkLatexWolfFemaleModel> animator;
    ...
    @Override
    public HumanoidAnimator<DarkLatexWolfFemale, DarkLatexWolfFemaleModel> getAnimator(DarkLatexWolfFemale entity) {
        return animator;
    }
}