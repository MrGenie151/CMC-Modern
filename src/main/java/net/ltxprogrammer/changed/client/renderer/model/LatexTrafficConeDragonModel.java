...
@OnlyIn(Dist.CLIENT)
public class LatexTrafficConeDragonModel extends AdvancedHumanoidModel<LatexTrafficConeDragon> {
    ...
    private final HumanoidAnimator<LatexTrafficConeDragon, LatexTrafficConeDragonModel> animator;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Horn_r1 = RightHorns.addOrReplaceChild("Horn_r1", CubeListBuilder.create().texOffs(15, 53).addBox(-2.7F, -9.0F, -5.25F, 1.0F, 6.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.9599F, -0.3927F, -0.3054F));

        PartDefinition Horn_r2 = RightHorns.addOrReplaceChild("Horn_r2", CubeListBuilder.create().texOffs(24, 0).addBox(-1.75F, -11.0F, -6.0F, 2.0F, 6.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, 0.0F, -0.3054F));

        PartDefinition LeftHorns = Head.addOrReplaceChild("LeftHorns", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition Horn_r3 = LeftHorns.addOrReplaceChild("Horn_r3", CubeListBuilder.create().texOffs(23, 53).addBox(1.7F, -9.0F, -5.25F, 1.0F, 6.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.9599F, 0.3927F, 0.3054F));

        PartDefinition Horn_r4 = LeftHorns.addOrReplaceChild("Horn_r4", CubeListBuilder.create().texOffs(0, 0).addBox(-0.25F, -11.0F, -6.0F, 2.0F, 6.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, 0.0F, 0.3054F));
