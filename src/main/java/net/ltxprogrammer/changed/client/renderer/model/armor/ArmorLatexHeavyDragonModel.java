...
public class ArmorLatexHeavyDragonModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexHeavyDragonModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexHeavyDragonModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_dragon_heavy_unified"), ArmorLatexHeavyDragonModel::createArmorLayer, ArmorLatexHeavyDragonModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexHeavyDragonModel<T>> animator;

    public ArmorLatexHeavyDragonModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexHeavyDragonModel<T>> getAnimator(T entity) {
        return animator;
    }
