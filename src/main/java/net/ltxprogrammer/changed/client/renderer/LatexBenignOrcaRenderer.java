...
public class LatexBenignOrcaRenderer extends AdvancedHumanoidRenderer<LatexBenignOrca, LatexBenignOrcaModel, ArmorLatexOrcaModel<LatexBenignOrca>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(LatexBenignOrca p_114482_) {
        return Changed.modResource("textures/latex_benign_orca.png");
    }
}