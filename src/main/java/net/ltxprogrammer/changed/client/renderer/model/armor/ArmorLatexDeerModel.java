...
public class ArmorLatexDeerModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexDeerModel<T>> {
    ...
    public ArmorLatexDeerModel(ModelPart modelPart, ArmorModel model) {
        ...
        animator = HumanoidAnimator.of(this).hipOffset(-1.5f)
                .addPreset(AnimatorPresets.deerLikeArmor(Head, Torso, LeftArm, RightArm,
    ...
    public static LayerDefinition createArmorLayer(ArmorModel layer) {
        ...
        PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(3, 20).addBox(-1.5F, 1.1F, -0.6F, 3.0F, 3.0F, 3.0F, layer.altDeformation.extend(0.01F)), PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, 1.1781F, 0.0F, 0.0F));
