...
public class WhiteLatexWolfMaleModel extends AdvancedHumanoidModel<WhiteLatexWolfMale> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("white_latex_wolf_male"), "main");
    ...
    private final HumanoidAnimator<WhiteLatexWolfMale, WhiteLatexWolfMaleModel> animator;

    public WhiteLatexWolfMaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public HumanoidAnimator<WhiteLatexWolfMale, WhiteLatexWolfMaleModel> getAnimator(WhiteLatexWolfMale entity) {
        return animator;
    }
}
