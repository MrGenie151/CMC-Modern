...
@OnlyIn(Dist.CLIENT)
public class PhageLatexWolfMaleModel extends AdvancedHumanoidModel<PhageLatexWolfMale> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("phage_latex_wolf_male"), "main");
    ...
    private final HumanoidAnimator<PhageLatexWolfMale, PhageLatexWolfMaleModel> animator;

    public PhageLatexWolfMaleModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightPad = RightFoot.addOrReplaceChild("RightPad", CubeListBuilder.create().texOffs(24, 0).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 2.0F, 5.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 4.325F, -4.425F));
        ...
        PartDefinition LeftPad = LeftFoot.addOrReplaceChild("LeftPad", CubeListBuilder.create().texOffs(43, 50).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 2.0F, 5.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 4.325F, -4.425F));
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, CubeDeformation.NONE)
                .texOffs(15, 32).addBox(-1.5F, -1.0F, -6.0F, 3.0F, 1.0F, 2.0F, CubeDeformation.NONE)
                .texOffs(44, 57).addBox(-2.0F, -3.0F, -7.0F, 4.0F, 2.0F, 3.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -0.5F, 0.0F));
        ...
        PartDefinition RightEarPivot = RightEar.addOrReplaceChild("RightEarPivot", CubeListBuilder.create().texOffs(0, 4).addBox(-1.9F, -1.2F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.05F))
                .texOffs(0, 18).addBox(-0.9F, -1.6F, -0.4F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.04F))
                .texOffs(0, 22).addBox(-0.9F, -2.3F, -1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.05F))
        ...
        PartDefinition LeftEarPivot = LeftEar.addOrReplaceChild("LeftEarPivot", CubeListBuilder.create().texOffs(0, 0).addBox(-1.1F, -1.2F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.05F))
                .texOffs(20, 35).addBox(-1.1F, -1.6F, -0.4F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.04F))
                .texOffs(37, 0).addBox(-1.1F, -2.3F, -1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.05F))
        ...
        CubeListBuilder maskList = CubeListBuilder.create().texOffs(32, 22).addBox(-2.0F, -3.0F, -2.0F, 4.0F, 3.0F, 3.0F, CubeDeformation.NONE);
        CubeListBuilderExtender extender = (CubeListBuilderExtender)maskList;

        extender.addTriangle("RightTriangle", // 0, 16
                -2.0f, -3.0f, -2.0f, 3.0f, 18.0f,
                -3.925f, -3.0f, 0.3f, 0.0f, 18.0f,
                -2.0f, -4.925f, 0.3f, 1.5f, 16.0f
        );
        extender.addTriangle("LeftTriangle", // 24, 22
                2.0f, -3.0f, -2.0f, 24.0f, 24.0f,
                2.0f, -4.925f, 0.3f, 25.5f, 22.0f,
                3.925f, -3.0f, 0.3f, 27.0f, 24.0f
        );

        PartDefinition Mask = Head.addOrReplaceChild("Mask", maskList, PartPose.offset(0.0F, -3.0F, -4.0F));

        PartDefinition cube_r2 = Mask.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 60).addBox(0.0F, -1.5F, 0.0F, 3.0F, 4.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(2.0F, -1.5F, -2.0F, 0.0F, -0.8727F, 0.0F));

        PartDefinition cube_r4 = Mask.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(58, 55).addBox(0.0F, -1.5F, 0.0F, 2.0F, 4.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-2.0F, -1.5F, -2.0F, 0.0F, -0.6981F, 0.0F));

        PartDefinition cube_r5 = Mask.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(56, 50).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 2.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, -3.0F, -2.0F, 0.6981F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(28, 55).addBox(-2.0F, 0.75F, -1.5F, 4.0F, 5.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.1781F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r3 = TailTertiary.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(52, 32).addBox(-2.0F, -1.2F, -1.95F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, 1.8326F, 0.0F, 0.0F));

        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 44).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, CubeDeformation.NONE), PartPose.offset(-5.0F, 1.5F, 0.0F));
