...
public class ArmorLatexMothModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexMothModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexMothModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_moth_unified"), ArmorLatexMothModel::createArmorLayer, ArmorLatexMothModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexMothModel<T>> animator;

    public ArmorLatexMothModel(ModelPart modelPart, ArmorModel model) {
        ...
        animator = HumanoidAnimator.of(this).hipOffset(-1.5f)
                .addPreset(AnimatorPresets.mothLikeArmor(Head, Torso, LeftArm, RightArm,
    ...
    public static LayerDefinition createArmorLayer(ArmorModel layer) {
        ...
        PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.75F, -1.5F, 4.0F, 4.0F, 4.0F, layer.altDeformation.extend(-0.3F)), PartPose.offsetAndRotation(0.0F, 0.4F, -0.3F, 1.0908F, 0.0F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexMothModel<T>> getAnimator(T entity) {
        return animator;
    }
