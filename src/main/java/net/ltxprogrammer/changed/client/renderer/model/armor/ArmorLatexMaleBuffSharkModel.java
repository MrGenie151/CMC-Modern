...
public class ArmorLatexMaleBuffSharkModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexMaleBuffSharkModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexMaleBuffSharkModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_shark_male_buff_unified"), ArmorLatexMaleBuffSharkModel::createArmorLayer, ArmorLatexMaleBuffSharkModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexMaleBuffSharkModel<T>> animator;

    public ArmorLatexMaleBuffSharkModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexMaleBuffSharkModel<T>> getAnimator(T entity) {
        return animator;
    }
