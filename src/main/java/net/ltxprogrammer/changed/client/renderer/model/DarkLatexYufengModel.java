...
@OnlyIn(Dist.CLIENT)
public class DarkLatexYufengModel extends AdvancedHumanoidModel<DarkLatexYufeng> {
    ...
    private final HumanoidAnimator<DarkLatexYufeng, DarkLatexYufengModel> animator;
