...
public class LatexSnowLeopardMaleModel extends AdvancedHumanoidModel<LatexSnowLeopardMale> {
    ...
    @Override
    public HumanoidAnimator<LatexSnowLeopardMale, LatexSnowLeopardMaleModel> getAnimator(LatexSnowLeopardMale entity) {
        return animator;
    }
}
