...
public class ArmorLatexBigTailDragonModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexBigTailDragonModel<T>> {
    ...
    public ArmorLatexBigTailDragonModel(ModelPart modelPart, ArmorModel model) {
    ...
    public static LayerDefinition createArmorLayer(ArmorModel layer) {
        ...
        PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(0, 20).addBox(-2.0F, -8.55F, 12.1F, 4.0F, 4.0F, 4.0F, layer.altDeformation.extend(0.5F)), PartPose.offsetAndRotation(0.0F, 16.0F, 0.0F, 1.0036F, 0.0F, 0.0F));
