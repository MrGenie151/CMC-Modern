...
public class LatexSnowLeopardFemaleModel extends AdvancedHumanoidModel<LatexSnowLeopardFemale> {
    ...
    private final HumanoidAnimator<LatexSnowLeopardFemale, LatexSnowLeopardFemaleModel> animator;
