...
public class GasWolfMaleModel extends AdvancedHumanoidModel<GasWolfMale> implements AdvancedHumanoidModelInterface<GasWolfMale, GasWolfMaleModel> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("gas_wolf_male"), "main");
    ...
    private final HumanoidAnimator<GasWolfMale, GasWolfMaleModel> animator;

    public GasWolfMaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GasWolfMale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
        this.prepareMobModel(animator, p_102861_, p_102862_, p_102863_, p_102864_);
    }

    public void setupHand(GasWolfMale entity) {
        animator.setupHand();
    }

    @Override
    public void setupAnim(@NotNull GasWolfMale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<GasWolfMale, GasWolfMaleModel> getAnimator(GasWolfMale entity) {
        return animator;
    }
}
