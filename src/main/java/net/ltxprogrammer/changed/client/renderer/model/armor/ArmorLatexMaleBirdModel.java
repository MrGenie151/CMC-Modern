...
public class ArmorLatexMaleBirdModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexMaleBirdModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexMaleBirdModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_bird_male_unified"), ArmorLatexMaleBirdModel::createArmorLayer, ArmorLatexMaleBirdModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexMaleBirdModel<T>> animator;

    public ArmorLatexMaleBirdModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexMaleBirdModel<T>> getAnimator(T entity) {
        return animator;
    }
