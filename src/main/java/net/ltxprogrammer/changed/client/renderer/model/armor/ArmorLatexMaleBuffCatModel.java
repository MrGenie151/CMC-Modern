...
public class ArmorLatexMaleBuffCatModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexMaleBuffCatModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexMaleBuffCatModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_cat_male_buff_unified"), ArmorLatexMaleBuffCatModel::createArmorLayer, ArmorLatexMaleBuffCatModel::new);
    ...
    private final HumanoidAnimator<T, ArmorLatexMaleBuffCatModel<T>> animator;

    public ArmorLatexMaleBuffCatModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexMaleBuffCatModel<T>> getAnimator(T entity) {
        return animator;
    }
