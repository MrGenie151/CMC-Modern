...
public class FacilityStaircaseEnd extends FacilitySinglePiece {
    ...
    public FacilityStaircaseEnd(ResourceLocation templateName) {
        super(ChangedFacilityPieceTypes.STAIRCASE_END.get(), templateName, LootTables.LOW_TIER_LAB);
    }

    public FacilityStaircaseEnd(ResourceLocation templateName, ResourceLocation lootTable) {
