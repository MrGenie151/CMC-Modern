...
public class ChangedWallSigns {
    ...
    public static final RegistryObject<WallSignVariant> DO_NOT_TOUCH_LATEXES = register(20, 40, "do_not_touch_latexes");
    public static final RegistryObject<WallSignVariant> DO_NOT_SPEAK_WITH_DARK_LATEXES = register(20, 40, "do_not_speak_with_dark_latexes");
}
